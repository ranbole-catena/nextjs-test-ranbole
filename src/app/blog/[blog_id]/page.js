...
async function getData(userId) {
  ...
  content +=
    "<p>Those licensees should begin to take bets as soon as Sept. 7 across the state. For instance, Churchill Downs has already confirmed its plans to do so on that date at six locations across Kentucky. In order to facilitate that legal sports betting activity, a catalog of eligible events is necessary.</p>";
